...
public class Animateur {
	...
	// Constructeurs
	public Animateur(int id, String nom, String prenom, String email, String motdepasse) {
		this._id = id;
		this._nom = nom;
		this._prenom = prenom;
		this._email = email;
	...
	public String toString() {
		...
		return "<span class='font-weight-bold'><span class='text-success'>Vous êtes bien connecté en tant que :</span></span><br><br>Animateur N° "
