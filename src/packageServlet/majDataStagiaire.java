...
/**
 * Servlet implementation class majDataStagiaire
 * 
 * https://web.maths.unsw.edu.au/~lafaye/CCM/servlets/servsession.htm
 * 
 */
public class majDataStagiaire extends HttpServlet {
	...
	private void processRequest(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			DalDAOJdbc.majDataStagiaire(cfg, Integer.parseInt(id), nom, prenom, email);
			// Recupère la session
	...
	public void init(ServletConfig config) throws ServletException {
		super.init(config);
		cfg = config;
		System.out.println("Je suis dans le init du majDataStagiaire\n");
	}
}
