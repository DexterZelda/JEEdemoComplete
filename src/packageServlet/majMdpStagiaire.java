...
/**
 * Servlet implementation class majMdpStagiaire
 * 
 * https://web.maths.unsw.edu.au/~lafaye/CCM/servlets/servsession.htm
 * 
 */
public class majMdpStagiaire extends HttpServlet {
	...
	private void processRequest(HttpServletRequest request, HttpServletResponse response)
		...
		String id = request.getParameter("idStagiaire");
		String mdp = request.getParameter("majMdpStagiaire");
		try {
			DalDAOJdbc.majMdpStagiaire(cfg, Integer.parseInt(id), mdp);
			// Recupère la session
	...
	public void init(ServletConfig config) throws ServletException {
		super.init(config);
		cfg = config;
		System.out.println("Je suis dans le init du majMdpStagiaire\n");
	}
}
